...
class WorkOrderObserver
{
    ...
    private function getRelationshipMapping(): array
    {
        ...
        $mapping = [
            ...
            'assigned_vendor_id' => ['relationship' => 'assignedVendor', 'model' => \App\Models\Vendor::class],
            'vendor_staff_id' => ['relationship' => 'vendorStaff', 'model' => \App\Models\VendorStaff::class],
    ...
    private function generateDescription(string $field, $oldValue, $newValue, WorkOrder $workOrder): string
    {
        $fieldLabels = [
            ...
            'assigned_vendor_id' => 'Assigned Vendor',
            'vendor_staff_id' => 'Vendor Staff (Technician)',
